...
const { defineCommands } = require('../src/commands');
const { default: runInteractive } = require('../src/interactive');
...
More information about each command may be retrieved with --help.`)
		...
		.options({
			...
			scope: {
				description: 'OAuth 2.0 scope parameter. Typically used for sudo.',
			},
			auth_token: {
				description: 'The one-time token generated for 2FA.',
			},
			debug: {
